...
# pontos a tirar: 250 e 251 (251 é madeira acho)
...
# ou melhor que isso, como tenho matrix, posso pegar na DB original só dos casos/controlos, adicionar uma ultima linha com FMV
